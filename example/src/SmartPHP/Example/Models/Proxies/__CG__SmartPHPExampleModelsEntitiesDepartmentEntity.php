...
namespace DoctrineProxies\__CG__\SmartPHP\Example\Models\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DepartmentEntity extends \SmartPHP\Example\Models\Entities\DepartmentEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SmartPHP\\Example\\Models\\Entities\\DepartmentEntity' . "\0" . 'id', '' . "\0" . 'SmartPHP\\Example\\Models\\Entities\\DepartmentEntity' . "\0" . 'name', '' . "\0" . 'SmartPHP\\Example\\Models\\Entities\\DepartmentEntity' . "\0" . 'company', '' . "\0" . 'SmartPHP\\Example\\Models\\Entities\\DepartmentEntity' . "\0" . 'employees'];
        }
