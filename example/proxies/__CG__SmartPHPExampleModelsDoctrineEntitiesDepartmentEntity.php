 ...
 */
class DepartmentEntity extends \SmartPHP\Example\Models\DoctrineEntities\DepartmentEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\DepartmentEntity' . "\0" . 'id', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\DepartmentEntity' . "\0" . 'name', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\DepartmentEntity' . "\0" . 'company', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\DepartmentEntity' . "\0" . 'employees'];
        }
