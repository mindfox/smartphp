 ...
 */
class CompanyEntity extends \SmartPHP\Example\Models\DoctrineEntities\CompanyEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\CompanyEntity' . "\0" . 'id', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\CompanyEntity' . "\0" . 'name', '' . "\0" . 'SmartPHP\\Example\\Models\\DoctrineEntities\\CompanyEntity' . "\0" . 'departments'];
        }
